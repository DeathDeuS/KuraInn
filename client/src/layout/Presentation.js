...
class Presentation extends Component {
    ...
    return (
        <div>
            ...
            <section id="presentation" className="container text-center">
                <h2>Kura Inn pour une expérience inoubliable</h2>
                <br />
                <img className="img_p_home w-100" src="../../asset/s1.jpg" />
                <br />
                <br />
                <article className="col-50">
                    <em>Présentation de la pension</em> : Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent quis felis
                    fermentum, lacinia nulla sed, feugiat tellus. Nulla facilisi. Class aptent taciti sociosqu ad litora torquent
                    per conubia nostra, per inceptos himenaeos. Donec bibendum nibh eu magna semper, et placerat elit pharetra. Fusce
                    at pulvinar orci. Sed aliquam lectus eget lectus accumsan auctor. Nunc et pharetra neque, nec tincidunt magna.
                    Vestibulum sed hendrerit lectus. In leo libero, tincidunt nec cursus vitae, ultrices in enim. Pellentesque sed
                    lobortis dui. Aenean sed pellentesque purus, eu vulputate velit. Phasellus scelerisque diam nec orci vehicula
                    blandit nec nec tellus. Nullam faucibus pellentesque dolor a fermentum. Cras eu dictum mauris, at eleifend orci.</article>
                <hr />
                <br />
                ...
                <div id="presentation_picture_manager" className="row  ">
                    ...
                    <br />
                    <article className="col-50">
                    <em>Présentation du personnel </em>: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent quis felis
                    fermentum, lacinia nulla sed, feugiat tellus. Nulla facilisi. Class aptent taciti sociosqu ad litora torquent
                    per conubia nostra, per inceptos himenaeos. Donec bibendum nibh eu magna semper, et placerat elit pharetra.
                    Fusce at pulvinar orci. Sed aliquam lectus eget lectus accumsan auctor. Nunc et pharetra neque, nec tincidunt
                    magna. </article>
                </div>
                <hr />
                <br />
                ...
                <div className="row">
                    ...
                    <div className="embed-responsive embed-responsive-16by9">
                        <iframe className="embed-responsive-item" src="https://www.youtube.com/embed/wmpYaehBeeE" />
                    </div>
                    </div>
                </div>
            </section>
